...
//   void initState() {
//     super.initState();
//     _startTimerAndRedirect();
//   }
//
//   Future<void> _startTimerAndRedirect() async {
...
//
//       debugPrint("🚀 [Splashscreen] Current role: $role");
//
//       if (user == null) {
//         // 🔸 No user → guest or login selection
//         if (role == "guest") {
