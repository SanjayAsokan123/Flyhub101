...
//     loadBuyerInfo();
//
//     // REMOVED AUTO-FILL OF LOCATION AND PHONE NUMBER
//     // User will manually input these fields
//   }
//
//   @override
//   void dispose() {
...
//     final pilotPriceDay = widget.pilot['price']?['perDay']?.toString() ?? '9600';
//
//     // Get contact info for display - REMOVED FROM DISPLAY
//     // final contactPerson = widget.pilot['contactPerson'] ?? '';
//     // final contactEmail = widget.pilot['contactEmail'] ?? widget.pilot['newemail'] ?? '';
//     // final contactPhone = widget.pilot['contactPhone'] ?? widget.pilot['newphoneNumber'] ?? '';
//
...
//                           ),
//
//                           // REMOVED CONTACT INFO DISPLAY FROM HERE
//                           // Contact info is no longer displayed at the top
//
//                           const SizedBox(height: 6),
//                           Column(
//                             crossAxisAlignment: CrossAxisAlignment.start,
...
//                     buildDurationDisplay(),
//
//                     // Location Field - NO LONGER AUTO-FILLED
//                     buildTextField(
//                       label: 'Enter Location *',
//                       icon: Icons.location_on,
//                       controller: locationController,
...
//                     ),
//
//                     // Contact Number Field - NO LONGER AUTO-FILLED
//                     buildTextField(
//                       label: 'Contact Number *',
//                       icon: Icons.phone,
//                       controller: contactController,
                  ...
                  children: [
                    Row(
                      children: [
                        ...
                        const SizedBox(width: 12),
                        // REMOVED BUYER/SELLER PILOT BADGE FROM HEADER
                      ],
                    ),
                    const SizedBox(height: 20),
                    Text(
