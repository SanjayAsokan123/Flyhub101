...
class _AddDroneRentalFormState extends State<AddDroneRentalForm> {
  ...
  Future<String> _uploadImageToFirebase(File file) async {
    ...
    try {
      ...
      final fileName =
          "rental_drones/${uid}_${DateTime.now().millisecondsSinceEpoch}.jpg";
  ...
  Future<void> _submitForm() async {
    ...
    try {
      ...
      debugPrint(
          "Data: name=$name, brand=$brand, pricePerHour=$pricePerHour, pricePerDay=$pricePerDay");
                  ...
                  child: Column(
                    children: [
                      ...
                      _buildTextField(
                        ...
                        validator: (v) =>
                            v!.isEmpty ? "Drone name is required" : null,
                      ),
                      const SizedBox(height: 16),
                      _buildTextField(
                        "Brand *",
                      ...
                      _buildTextField(
                        ...
                        maxLines: 3,
                        hintText:
                            "Describe rental terms, drone condition, features, etc...",
    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          ...
          validator: validator ??
              ((v) => (v == null || v.isEmpty)
                  ? "Please enter ${label.replaceAll('*', '').trim()}"
                  : null),
          onSaved: onSaved,
        ),
      ],
