...
const Color kWarningColor = Color(0xFFF59E0B); // ADD THIS
const Color kErrorColor = Color(0xFFEF4444); // ADD THIS
...
class _ServicesPageState extends State<ServicesPage> {
  ...
  // ✅ ADD THIS: Handle service booking with auth check
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          ...
          return Material(
            ...
            child: InkWell(
              borderRadius: BorderRadius.circular(ResponsiveUtils.getOptimalCardRadius(context)),
              onTap: () => _handleServiceBooking(service), // ✅ CHANGED: Use auth-checked handler
              child: Row(
                children: [
                        ...
                        children: [
                          ...
                          Row(
                            ...
                            children: [
                              ...
                              ElevatedButton(
                                onPressed: () => _handleServiceBooking(service), // ✅ CHANGED: Use auth-checked handler
                                style: ElevatedButton.styleFrom(
                                  backgroundColor: kPrimaryColor,
                                  padding: EdgeInsets.symmetric(
                                    horizontal: ResponsiveUtils.getHorizontalPadding(context) * 0.8,
