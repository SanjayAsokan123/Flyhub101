...
class _MarketPageState extends State<MarketPage>
  ...
  void initState() {
    ...
    _dronesScrollController
        .addListener(() => _handleScroll('drones', _dronesScrollController));
    _partsScrollController
        .addListener(() => _handleScroll('parts', _partsScrollController));
    _accessoriesScrollController.addListener(
        () => _handleScroll('accessories', _accessoriesScrollController));
  ...
  Future<void> _fetchCategoryData(String category,
    ...
    switch (category) {
      ...
      case 'accessories':
        result =
            await _api.getAccessoriesPaginated(page: currentPage, limit: limit);
        break;
    }
  ...
  Future<void> _loadMore(String category) async {
    if (paginationState[category]['isLoadingMore'] ||
        !paginationState[category]['hasMore']) return;
    ...
    var result = list.where((item) {
      if (searchQuery.isNotEmpty) {
        ...
        if (!(name.contains(searchQuery.toLowerCase()) ||
            brand.contains(searchQuery.toLowerCase()))) return false;
      }
  ...
  void _showFilterModal() {
    showModalBottomSheet(
      ...
      builder: (ctx) => Container(
        height:
            ResponsiveUtils.getSafeContainerHeight(context, percentage: 0.8),
              ...
              child: Column(
                ...
                children: [
                      ...
                      IconButton(
                        ...
                        icon: Container(
                          ...
                          decoration: BoxDecoration(
                              color: kLightBackground, shape: BoxShape.circle),
                  ...
                  Text("Price Range",
                      style: GoogleFonts.inter(
                          fontSize:
                              ResponsiveUtils.getTitleFontSize(context) - 2,
                  ...
                  Container(
                    ...
                    child: DropdownButton<String>(
                      ...
                      onChanged: (String? newValue) =>
                          setModal(() => selectedBrand = newValue ?? 'All'),
                    ),
                  ),
                  SizedBox(height: ResponsiveUtils.getSectionSpacing(context)),
                  Text("Sort By",
                  ...
                  Container(
                    ...
                    child: DropdownButton<String>(
                      ...
                      onChanged: (String? newValue) =>
                          setModal(() => sortBy = newValue ?? 'Recommended'),
                    ),
                  ),
                  SizedBox(
                      height: ResponsiveUtils.getSectionSpacing(context) + 8),
                  Row(
                    children: [
                      Expanded(
          ...
          child: Column(
            ...
            children: [
              Container(
                  ...
                  height: MediaQuery.of(context).size.width / crossCount * 0.7,
                  decoration: BoxDecoration(
                      color: kShimmerColor,
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Row(
                          ...
                          children: [
                            Container(
                                width: 50, height: 16, color: kShimmerColor),
                            Container(
                                width: 30, height: 20, color: kShimmerColor)
                          ]),
                    ],
                  ),
                ),
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Container(
            width:
                ResponsiveUtils.getPilotButtonHeight(context, percentage: 0.05),
            height:
                ResponsiveUtils.getPilotButtonHeight(context, percentage: 0.05),
    ...
    return Scaffold(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              Navigator.push(context,
                  MaterialPageRoute(builder: (_) => WishlistPage())).then((_) {
                if (mounted) setState(() {});
              });
            },
          ),
          Stack(
            children: [
              ...
              if (cartCount > 0)
                Positioned(right: 6, top: 6, child: _badge(cartCount)),
            ],
          ),
        ],
        bottom: PreferredSize(
          preferredSize:
              Size.fromHeight(ResponsiveUtils.getMarketTabBarHeight(context)),
          child: Column(
            children: [
              Padding(
                padding: EdgeInsets.symmetric(
      ...
      body: TabBarView(
        ...
        children: [
          ...
          _buildGridView(
              'accessories', filteredAccessories, _accessoriesScrollController),
        ],
      ),
    );
  }
  ...
  Widget _buildGridView(
      String category, List<dynamic> items, ScrollController scrollController) {
      ...
      child: Padding(
        ...
        child: GridView.builder(
          ...
          itemCount: items.length +
              (isLoadingMore ? 1 : 0) +
              (hasMore && items.length >= paginationState[category]['limit']
                  ? 1
                  : 0),
            ...
            if (index == items.length) {
              if (isLoadingMore) {
                return Center(
                  ...
                  items.length >= paginationState[category]['limit']) {
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                            height: ResponsiveUtils.getCardMargin(context) / 4),
                        Expanded(
                          child: Text(
                            item['name'] ?? '',
                            style: GoogleFonts.inter(
                        ...
                        SizedBox(
                            height: ResponsiveUtils.getCardMargin(context) / 2),
                        Text(
